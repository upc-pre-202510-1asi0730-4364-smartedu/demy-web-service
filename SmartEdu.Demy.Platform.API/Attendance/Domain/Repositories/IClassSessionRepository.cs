...
public interface IClassSessionRepository : IBaseRepository<ClassSession>
{
    ...
    Task<List<AttendanceRecord>> FindAttendanceRecordsByDniCourseAndDateRangeAsync(int courseId, string dni, DateOnly startDate, DateOnly endDate);
    /// <summary>
    ...
    Task<List<ClassSession>> FindSessionsByCourseAndDateRangeAsync(int courseId, DateOnly startDate, DateOnly endDate);
